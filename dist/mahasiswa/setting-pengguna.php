...
session_start();
    if (isset($_POST['submit'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            //Mengambil password
            $ambil_password=mysqli_query($kon,"select password from pengguna where kode_pengguna='$kode_mahasiswa' limit 1");
...
<form action="dist/mahasiswa/setting-pengguna.php" method="post">
<?php
    include '../../config/database.php';
...
<script>
    //Event untuk cek ketersediaan username
