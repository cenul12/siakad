    ...
    if (isset($_POST['edit_karyawan'])) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($edit_karyawan) {
                ...
                header("Location:../../index.php?page=karyawan&edit=berhasil");
            }
            else {
                mysqli_query($kon,"ROLLBACK");
                header("Location:../../index.php?page=karyawan&edit=gagal");
            }
        }
    }
?>
...
<form action="dist/karyawan/edit.php" method="post" enctype="multipart/form-data">
    <div class="row">
        <div class="col-sm-7">
    ...
    <div class="row">
        <div class="col-sm-3">
        <label>Foto:</label><br>
            <img src="dist/karyawan/foto/<?php echo $data['foto'];?>" id="preview" width="90%" class="rounded" alt="Cinque Terre">
